    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="manage-ctravao" method="post">
                ...
                <div class="form-group form-group-half" style="margin-left: 2%;">
                ...
                <% if(isEdit) { %>
                    <a href="manage-ctravao" class="btn btn-add" style="text-decoration: none; display:inline-block; margin-left:10px; background:#6c757d;">Hủy</a>
                <% } %>
            </form>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="manage-ctravao?action=delete&id=<%= ctv.getStrMaCTRaVao() %>" class="btn btn-delete" onclick="return confirm('Bạn có chắc muốn xóa chi tiết ra vào này?');">Xóa</a>
                    </td>
                </tr>
                <%      }
                    } else { %>
